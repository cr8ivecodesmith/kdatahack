...
class BidLineItem(models.Model):
    ...
    modified_date = models.DateTimeField(blank=True)
    master_item = models.ForeignKey('masteritems.MasterItem', related_name='bidlineitem_set', blank=True, null=True)
...
class BidInformation(models.Model):
    ...
    procuring_entity_org_id = models.ForeignKey('Organization', to_field='org_id', related_name='procuring_bid_information')
    procuring_entity_org = models.CharField(blank=True, max_length=2048)
    client_agency_org_id = models.ForeignKey('Organization', to_field='org_id', related_name='client_bid_information')
