    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('award_id', models.ForeignKey(to='philgeps.Awards', to_field=b'award_id')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('line_item_id', models.PositiveIntegerField(unique=True)),
                ('item_name', models.CharField(max_length=2048, blank=True)),
                ...
                ('ref_id', models.ForeignKey(to='philgeps.BidInformation', to_field=b'ref_id')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='client_bid_information', to='philgeps.Organization', to_field=b'org_id'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bidinformation',
            name='org_id',
            field=models.ForeignKey(related_name='bid_information', to='philgeps.Organization', to_field=b'org_id'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bidinformation',
            name='procuring_entity_org_id',
            field=models.ForeignKey(related_name='procuring_bid_information', to='philgeps.Organization', to_field=b'org_id'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bidderslist',
            name='line_item_id',
            field=models.ForeignKey(to='philgeps.BidLineItem', to_field=b'line_item_id'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='bidderslist',
            name='org_id',
            field=models.ForeignKey(to='philgeps.Organization', to_field=b'org_id'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='awards',
        ...
        migrations.AddField(
            model_name='awards',
            name='ref_id',
            field=models.ForeignKey(to='philgeps.BidInformation', to_field=b'ref_id'),
            preserve_default=True,
        ),
    ]
